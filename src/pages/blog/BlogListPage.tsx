      ...
      <div className="mb-8 flex flex-col md:flex-row gap-4 md:items-center md:justify-between">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-white border border-slate-300 rounded-xl focus:outline-none focus:border-[#7B1F26]"
          />
        </div>
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-sm font-medium transition ${
                category === c
                  ...
                  : 'bg-white text-slate-700 border border-slate-200 hover:border-[#7B1F26]'
              }`}
            >
              {c === 'all' ? 'Tümü' : c}
            </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {posts.map((post) => (
          <Link
            key={post.slug}
            to={`/blog/${post.slug}`}
            className="group bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-[#7B1F26] hover:shadow-lg transition"
          >
            ...
            <div className="p-5">
              ...
              <h2 className="text-lg font-bold text-slate-900 group-hover:text-[#7B1F26] transition line-clamp-2">
                {post.title}
              </h2>
