                  ...
                  <div className="flex flex-wrap gap-2">
                    {POPULAR.map((p) => (
                      <button key={p} onClick={() => setQuery(p)}
                        className="px-3 py-1.5 text-xs bg-red-50 hover:bg-red-100 text-[#DC2626] rounded-full font-medium">
                        {p}
                      </button>
                    ))}
                  </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <p className="text-sm font-bold text-[#DC2626]">{price.toLocaleString('tr-TR')} €</p>
                      </div>
                      <ArrowRight size={14} className={activeIdx === i ? 'text-[#DC2626]' : 'text-slate-300'} />
                    </button>
                  );
                })}
              </div>
