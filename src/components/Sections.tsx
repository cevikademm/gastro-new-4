      ...
      <div className="max-w-[90rem] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {CATEGORIES.map((cat, idx) => (
            ...
            >
              <img src={cat.image} loading="lazy" decoding="async" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-[1.2s] ease-out" alt={cat.name} />
              ...
              <div className="absolute inset-0 p-6 sm:p-8 flex flex-col justify-end">
                <span className="text-[9px] font-bold tracking-[0.3em] text-white/80 uppercase mb-2 sm:mb-3 block">{cat.count}</span>
