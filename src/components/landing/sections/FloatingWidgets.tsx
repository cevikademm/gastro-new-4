...
export function FloatingWidgets() {
  ...
  return (
    <>
      ...
      {showTooltip && (
        <div
          className="fixed bottom-[104px] right-[100px] z-[89] px-4 py-3 bg-white rounded-xl hidden sm:flex md:bottom-[36px] items-center gap-2 text-[13px] font-semibold text-[color:var(--c-ink)] pointer-events-none"
      ...
      >
        ...
        />
        <svg width="30" height="30" viewBox="0 0 24 24" fill="currentColor" className="sm:h-8 sm:w-8">
