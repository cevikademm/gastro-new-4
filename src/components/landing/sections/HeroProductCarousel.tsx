...
const HERO_PRODUCTS: HeroProduct[] = [
  ...
  {
    id: 'FRM-5E-F',
    name: 'Bäckerei-Rotationsofen 15 Ebenen — Konditorei',
    brand: 'DIAMOND',
    line: 'GOLD LINE',
    img: 'https://diamond-eu-prod.s3.eu-central-1.amazonaws.com/media/81984/conversions/001-FRM-4E-L-big.jpg',
    price: 36293,
    oldPrice: 43552,
    stockDays: 1,
    chip: { label: 'Profesyonel' },
  },
  {
    id: 'CF-195T-S',
